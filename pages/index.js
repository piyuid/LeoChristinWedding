    ...
    <div className="relative">
      ...
      <div className="w-full lg:w-5/12 ml-auto">
        <div className="h-screen flex flex-col items-center p-10 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(../images/leochristin2.jpg)` }}>
          ...
          <img src="../images/down.gif" className="w-20 h-auto shadow-lg" alt="Scroll" />
        </div>
        ...
        <div className="bg-red-100 min-h-screen flex items-center flex-col p-10">
          ...
          <p className="text-6xl text-green-800 text-center font-Tangerine">Leo Puji Christyanto Simbolon</p>
          <p className="text-green-800 text-center mb-1">Putra Pertama dari Bapak Tambun Simbolon (†) dan Ibu Sri Sulistyowati Sinaga</p>
          ...
          <p className="text-6xl text-green-800 text-center font-Tangerine">Christin Putri Daly</p>
          <p className="text-green-800 text-center mb-1">Putri Kedua dari Bapak Sudiyarto (†) dan Ibu Martje Daly</p>
          <a href="https://www.instagram.com/christineputridaly/" target="_blank" rel="noreferrer">
            <img src="../images/instagram.png" className="mb-8 w-8 h-auto" alt="Scroll" href />
          </a>
        </div>
      </div>

      {/* Navbar bottom */}
      <section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-red-700 shadow drop-shadow-lg rounded-t-lg">
